...
INSERT INTO Produtos(idProduto, codigoProduto, nomeProduto, descricaoProduto, precoDeFabricacao, quantidadeEmEstoque)
VALUES
(default, 123, 'Sabão em pó', 'ajuda a lavar roupas', 20, 100),
(default, 456, 'Sabonete', 'ajuda a tomar banho', 5, 200),
(default, 789, 'Pente de cabelo', 'penteia o cabelo', 3, 300),
(default, 987, 'TV', 'pode assistir coisas nela', 1000, 50),
(default, 654, 'Aspirador de pó', 'ajuda a tirar a sujeira da casa', 100, 100),
(default, 321, 'Sabão em pó', 'ajuda a lavar roupas', 20, 100),
(default, 154, 'Sabão em pó', 'ajuda a lavar roupas', 20, 100),
(default, 849, 'Sabão em pó', 'ajuda a lavar roupas', 20, 100),
(default, 950, 'Sabão em pó', 'ajuda a lavar roupas', 20, 100),
(default, 504, 'Sabão em pó', 'ajuda a lavar roupas', 20, 100),