...
(default, 321, 'Vela', 'ilumina lugares escuros', 6, 150, 5, ),
(default, 154, 'Mesa de plástico', 'pode colocar em cima', 12, 27, 3, ),
(default, 849, 'Sofá', 'você pode descansar nele', 400, 100, 3, ),
(default, 950, 'Monitor', '24 polegadas, 140 hertz', 2000, 30, 1, ),
(default, 504, 'Mouse', 'mexe o cursos do computador', 30, 120, 1, );
